...
export class HttpClientService {
  ...
  put<T>(requestParameter:Partial<RequestParameter>,body:Partial<T>,id:number) : Observable<T>{
    let url:string="";
    if(requestParameter.fullEndPoint)
      url=requestParameter.fullEndPoint
    else
  ...
  delete<T>(requestParameter:Partial<RequestParameter>,id:number) : Observable<T>{
    let url:string="";
    if(requestParameter.fullEndPoint)
      url=requestParameter.fullEndPoint
    else
